					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								...
								java.util.List<com.HeJinLin.model.User> userList=(java.util.ArrayList<com.HeJinLin.model.User>)session.getAttribute("userList");
  										String  username1=userList.get(0).getUsername();
  										 out.print(userList.get(0).getUsername());
				...
				<div class="row">
					<div class="col-md-4 clearfix">
						<div class="logo pull-left">
							<a href="index.html"><img src="<%=basePath%>images/home/logo.png" alt="" /></a>
						</div>
