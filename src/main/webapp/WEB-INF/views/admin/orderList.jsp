		...
		<div class="table-responsive col-sm-10">
			<table class="table table-condensed">
				...
				<tr>
					...
					<td>${o.orderDate}</td>
					<%
						com.HeJinLin.model.Order o=(com.HeJinLin.model.Order)pageContext.findAttribute("o");
						int userId=o.getCustomerId();
						java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
						com.HeJinLin.dao.UserDao userDao=new com.HeJinLin.dao.UserDao();
					...
					<td class="cart_total">
						<%
							...
							String paymentType=com.HeJinLin.model.Payment.findByPaymentId(con,n);
						%>
