...
<script type="text/javascript">
	...
	//鏍囨敞鐐规暟缁?
	var markerArr = [{title:"华东交通大学",content:"鎴戠殑澶囨敞<br/>姹熻タ鐪佸崡鏄屽競缁忔祹鎶€鏈紑鍙戝尯鍙屾腐涓滃ぇ琛808鍙<br/>(0791)87046576",point:"115.873619|28.750131",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
	];
	//鍒涘缓marker
	function addMarker(){
